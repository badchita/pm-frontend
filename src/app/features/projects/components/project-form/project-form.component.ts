...
import { TaskListTableComponent } from '../../pages/edit-project/components/task-list-table.component/task-list-table.component';
...
export class ProjectFormComponent implements OnInit, OnDestroy {
  readonly onGetProject = output<Project>();
